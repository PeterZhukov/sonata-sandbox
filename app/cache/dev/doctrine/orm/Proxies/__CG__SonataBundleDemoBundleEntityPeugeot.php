 ...
 */
class Peugeot extends \Sonata\Bundle\DemoBundle\Entity\Peugeot implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'createdAt', 'engine', 'rescueEngine', 'color', 'inspections', 'media');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Peugeot $proxy) {
     ...
     * {@inheritDoc}
     */
    public function removeInspection(\Sonata\Bundle\DemoBundle\Entity\Inspection $inspection = NULL)
    {
