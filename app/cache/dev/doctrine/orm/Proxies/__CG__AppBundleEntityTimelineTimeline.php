 ...
 */
class Timeline extends \AppBundle\Entity\Timeline\Timeline implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'context', 'type', 'subject', 'action', 'createdAt');
        }
     ...
     * {@inheritDoc}
     */
    public function setSubject(\Spy\Timeline\Model\ComponentInterface $subject)
    {
