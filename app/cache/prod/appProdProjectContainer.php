...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.delivery.take_away' => 'getApp_Delivery_TakeAwayService',
            ...
            'sonata.notification.api.form.type.message' => 'getSonata_Notification_Api_Form_Type_MessageService',
    ...
    protected function getApp_Delivery_TakeAwayService()
    {
        return $this->services['app.delivery.take_away'] = new \Sonata\Bundle\DemoBundle\Model\TakeAwayDelivery();
    }
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('sonata_jqueryui_js' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.core.js'), 1 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.widget.js'), 2 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.mouse.js'), 3 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.draggable.js'), 4 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.droppable.js'), 5 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.resizable.js'), 6 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.selectable.js'), 7 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.sortable.js'), 8 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.effect.js'), 9 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.position.js'), 10 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/ui/jquery.ui.tooltip.js')), 1 => array(0 => 'yui_js'), 2 => array()), 'sonata_jqueryui_css' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css')), 1 => array(0 => 'cssrewrite', 1 => 'yui_css'), 2 => array()), 'sonata_formatter_js' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/vendor/markitup-markitup/markitup/jquery.markitup.js'), 1 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/sets/markdown/set.js'), 2 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/sets/html/set.js'), 3 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/sets/textile/set.js')), 1 => array(0 => 'yui_js'), 2 => array()), 'sonata_formatter_css' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/skins/sonata/style.css'), 1 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/sets/markdown/style.css'), 2 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/sets/html/style.css'), 3 => ($this->targetDirs[2].'/../web/bundles/sonataformatter/markitup/sets/textile/style.css')), 1 => array(0 => 'cssrewrite', 1 => 'yui_css'), 2 => array()), 'sonata_admin_js' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/jquery/dist/jquery.js'), 1 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.js'), 2 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/moment/min/moment.min.js'), 3 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.js'), 4 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js'), 5 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/jquery/form/jquery.form.js'), 6 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/jquery/jquery.confirmExit.js'), 7 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.js'), 8 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/select2/select2.js'), 9 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js'), 10 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/iCheck/icheck.min.js'), 11 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js'), 12 => ($this->targetDirs[2].'/../web/bundles/sonatapage/sonata-page.back.js'), 13 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/Admin.js'), 14 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/treeview.js')), 1 => array(0 => 'yui_js'), 2 => array()), 'sonata_admin_css' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css'), 1 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css'), 2 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/ionicons/css/ionicons.min.css'), 3 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.css'), 4 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/iCheck/skins/flat/blue.css'), 5 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/jqueryui/themes/flick/jquery-ui.min.css'), 6 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/select2/select2.css'), 7 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/select2/select2-bootstrap.css'), 8 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css'), 9 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css'), 10 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/css/styles.css'), 11 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/css/layout.css'), 12 => ($this->targetDirs[2].'/../web/bundles/sonataadmin/css/tree.css'), 13 => ($this->targetDirs[2].'/../web/bundles/sonatapage/sonata-page.back.css')), 1 => array(0 => 'cssrewrite', 1 => 'yui_css'), 2 => array()), 'sonata_front_js' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/jquery/dist/jquery.js'), 1 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.js'), 2 => ($this->targetDirs[2].'/../web/bundles/sonataproduct/js/product.js'), 3 => ($this->targetDirs[2].'/../web/bundles/sonatacore/js/base.js'), 4 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/select2/select2.min.js'), 5 => ($this->targetDirs[2].'/../web/bundles/sonatademo/js/demo.js')), 1 => array(0 => 'yui_js'), 2 => array()), 'sonata_front_css' => array(0 => array(0 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css'), 1 => ($this->targetDirs[2].'/../web/bundles/sonatacore/vendor/select2/select2.css'), 2 => ($this->targetDirs[2].'/../web/bundles/mopabootstrap/css/datepicker.css'), 3 => ($this->targetDirs[2].'/../web/bundles/sonatademo/css/demo.css')), 1 => array(0 => 'cssrewrite', 1 => 'yui_css'), 2 => array()))), 'config');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'dbname' => 'sonata_sandbox', 'user' => 'root', 'host' => '127.0.0.1', 'password' => NULL, 'charset' => 'UTF8', 'port' => NULL, 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\Resources\\config\\doctrine') => 'Sonata\\PageBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\media-bundle\\Resources\\config\\doctrine') => 'Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle\\Resources\\config\\doctrine') => 'Sonata\\NewsBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\Resources\\config\\doctrine') => 'Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\Resources\\config\\doctrine') => 'Sonata\\NotificationBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\classification-bundle\\Resources\\config\\doctrine') => 'Sonata\\ClassificationBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\OrderBundle\\Resources\\config\\doctrine') => 'Sonata\\OrderBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\PaymentBundle\\Resources\\config\\doctrine') => 'Sonata\\PaymentBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\ProductBundle\\Resources\\config\\doctrine') => 'Sonata\\ProductBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\InvoiceBundle\\Resources\\config\\doctrine') => 'Sonata\\InvoiceBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\CustomerBundle\\Resources\\config\\doctrine') => 'Sonata\\CustomerBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\BasketBundle\\Resources\\config\\doctrine') => 'Sonata\\BasketBundle\\Entity', ($this->targetDirs[3].'\\src\\AppBundle\\Resources\\config\\doctrine') => 'AppBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle\\Resources\\config\\doctrine') => 'FOS\\CommentBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\comment-bundle\\Resources\\config\\doctrine') => 'Sonata\\CommentBundle\\Entity', ($this->targetDirs[3].'\\vendor\\stephpy\\timeline-bundle\\Resources\\config\\doctrine') => 'Spy\\TimelineBundle\\Entity'));
        $b->setGlobalBasename('mapping');
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Sonata\\Bundle\\DemoBundle\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\sonata-project\\timeline-bundle\\Entity')));
        ...
        $e->setEntityNamespaces(array('SonataPageBundle' => 'Sonata\\PageBundle\\Entity', 'SonataMediaBundle' => 'Sonata\\MediaBundle\\Entity', 'SonataNewsBundle' => 'Sonata\\NewsBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'SonataNotificationBundle' => 'Sonata\\NotificationBundle\\Entity', 'SonataClassificationBundle' => 'Sonata\\ClassificationBundle\\Entity', 'SonataOrderBundle' => 'Sonata\\OrderBundle\\Entity', 'SonataPaymentBundle' => 'Sonata\\PaymentBundle\\Entity', 'SonataProductBundle' => 'Sonata\\ProductBundle\\Entity', 'SonataInvoiceBundle' => 'Sonata\\InvoiceBundle\\Entity', 'SonataCustomerBundle' => 'Sonata\\CustomerBundle\\Entity', 'SonataBasketBundle' => 'Sonata\\BasketBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity', 'FOSCommentBundle' => 'FOS\\CommentBundle\\Entity', 'SonataCommentBundle' => 'Sonata\\CommentBundle\\Entity', 'SonataDemoBundle' => 'Sonata\\Bundle\\DemoBundle\\Entity', 'SpyTimelineBundle' => 'Spy\\TimelineBundle\\Entity', 'SonataTimelineBundle' => 'Sonata\\TimelineBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e2a89e0b1dab5a4d102965d0d146687b559b810cbef8bdbd923be171b9ca47c5');
        return $instance;
    }
    ...
    {
        return $this->services['fos_comment.form_type.comment.default'] = new \FOS\CommentBundle\Form\CommentType('AppBundle\\Entity\\Comment\\Comment');
    }
    protected function getFosComment_FormType_CommentableThread_DefaultService()
    {
        return $this->services['fos_comment.form_type.commentable_thread.default'] = new \FOS\CommentBundle\Form\CommentableThreadType('AppBundle\\Entity\\Comment\\Thread');
    }
    protected function getFosComment_FormType_DeleteComment_DefaultService()
    {
        return $this->services['fos_comment.form_type.delete_comment.default'] = new \FOS\CommentBundle\Form\DeleteCommentType('AppBundle\\Entity\\Comment\\Comment');
    }
    protected function getFosComment_FormType_Thread_DefaultService()
    {
        return $this->services['fos_comment.form_type.thread.default'] = new \FOS\CommentBundle\Form\ThreadType('AppBundle\\Entity\\Comment\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'AppBundle\\Entity\\Comment\\Comment');
    }
    protected function getFosComment_Manager_Thread_DefaultService()
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('event_dispatcher'), $this->get('fos_comment.entity_manager'), 'AppBundle\\Entity\\Comment\\Thread');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \Sonata\UserBundle\Entity\GroupManager($this->get('fos_user.entity_manager'), 'AppBundle\\Entity\\User\\Group');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \Sonata\UserBundle\Entity\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'AppBundle\\Entity\\User\\User');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('AppBundle' => ($this->targetDirs[3].'\\src\\AppBundle/Resources/config/serializer'), 'Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle\\Sensio\\Bundle\\FrameworkExtraBundle/Resources/config/serializer'), 'JMS\\AopBundle' => ($this->targetDirs[3].'\\vendor\\jms\\aop-bundle\\JMS\\AopBundle/Resources/config/serializer'), 'JMS\\SecurityExtraBundle' => ($this->targetDirs[3].'\\vendor\\jms\\security-extra-bundle\\JMS\\SecurityExtraBundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\MigrationsBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-migrations-bundle\\Doctrine\\Bundle\\MigrationsBundle/Resources/config/serializer'), 'Knp\\Bundle\\MenuBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-menu-bundle\\Knp\\Bundle\\MenuBundle/Resources/config/serializer'), 'Knp\\Bundle\\MarkdownBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-markdown-bundle\\Knp\\Bundle\\MarkdownBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle\\Knp\\Bundle\\PaginatorBundle/Resources/config/serializer'), 'FOS\\UserBundle' => 'D:/WWW/testphp.local/sandbox/app/../vendor/sonata-project/user-bundle/Resources/config/serializer/FOSUserBundle', 'Sonata\\UserBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle/Resources/config/serializer'), 'Sonata\\PageBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle/Resources/config/serializer'), 'Sonata\\NewsBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle/Resources/config/serializer'), 'Sonata\\MediaBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\media-bundle/Resources/config/serializer'), 'Ivory\\CKEditorBundle' => ($this->targetDirs[3].'\\vendor\\egeloen\\ckeditor-bundle/Resources/config/serializer'), 'Sonata\\AdminBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle/Resources/config/serializer'), 'Sonata\\DoctrineORMAdminBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\doctrine-orm-admin-bundle/Resources/config/serializer'), 'SimpleThings\\EntityAudit' => ($this->targetDirs[3].'\\vendor\\simplethings\\entity-audit-bundle\\src\\SimpleThings\\EntityAudit/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle\\FOS\\RestBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'\\vendor\\nelmio\\api-doc-bundle\\Nelmio\\ApiDocBundle/Resources/config/serializer'), 'Sonata\\BasketBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\BasketBundle/Resources/config/serializer'), 'Sonata\\CustomerBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\CustomerBundle/Resources/config/serializer'), 'Sonata\\DeliveryBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\DeliveryBundle/Resources/config/serializer'), 'Sonata\\InvoiceBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\InvoiceBundle/Resources/config/serializer'), 'Sonata\\OrderBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\OrderBundle/Resources/config/serializer'), 'Sonata\\PaymentBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\PaymentBundle/Resources/config/serializer'), 'Sonata\\ProductBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\ProductBundle/Resources/config/serializer'), 'Sonata\\PriceBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\PriceBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'FOS\\CommentBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle/Resources/config/serializer'), 'Sonata\\CommentBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\comment-bundle/Resources/config/serializer'), 'Sonata\\EasyExtendsBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\easy-extends-bundle/Resources/config/serializer'), 'Sonata\\CoreBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle/Resources/config/serializer'), 'Sonata\\IntlBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\intl-bundle/Resources/config/serializer'), 'Sonata\\FormatterBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\formatter-bundle/Resources/config/serializer'), 'Sonata\\CacheBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\cache-bundle/Resources/config/serializer'), 'Sonata\\BlockBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle/Resources/config/serializer'), 'Sonata\\SeoBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle/Resources/config/serializer'), 'Sonata\\ClassificationBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\classification-bundle/Resources/config/serializer'), 'Sonata\\NotificationBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle/Resources/config/serializer'), 'Sonata\\DatagridBundle' => 'D:/WWW/testphp.local/sandbox/app/../vendor/sonata-project/datagrid-bundle/Resources/config/serializer', 'Symfony\\Cmf\\Bundle\\RoutingBundle' => ($this->targetDirs[3].'\\vendor\\symfony-cmf\\routing-bundle/Resources/config/serializer'), 'Sonata\\Bundle\\DemoBundle' => ($this->targetDirs[3].'\\src\\Sonata\\Bundle\\DemoBundle/Resources/config/serializer'), 'Sonata\\Bundle\\QABundle' => ($this->targetDirs[3].'\\src\\Sonata\\Bundle\\QABundle/Resources/config/serializer'), 'Spy\\TimelineBundle' => ($this->targetDirs[3].'\\vendor\\stephpy\\timeline-bundle/Resources/config/serializer'), 'Sonata\\TimelineBundle' => ($this->targetDirs[3].'\\vendor\\sonata-project\\timeline-bundle/Resources/config/serializer'), 'Mopa\\Bundle\\BootstrapBundle' => ($this->targetDirs[3].'\\vendor\\mopa\\bootstrap-bundle\\Mopa\\Bundle\\BootstrapBundle/Resources/config/serializer'), 'Sonata\\Component\\Basket' => 'D:/WWW/testphp.local/sandbox/app/../vendor/sonata-project/ecommerce/src/BasketBundle/Resources/config/serializer/Component'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => false, 2 => 1)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[2].'/cache/sessions'));
    }
    ...
    protected function getSimplethingsEntityaudit_ConfigService()
    {
        ...
        $instance->setAuditedEntityClasses(array(0 => 'AppBundle\\Entity\\User\\User', 1 => 'AppBundle\\Entity\\User\\Group', 2 => 'AppBundle\\Entity\\Page\\Page', 3 => 'AppBundle\\Entity\\Page\\Block', 5 => 'AppBundle\\Entity\\Page\\Snapshot', 6 => 'AppBundle\\Entity\\Page\\Site', 7 => 'AppBundle\\Entity\\News\\Post', 8 => 'AppBundle\\Entity\\News\\Comment', 9 => 'AppBundle\\Entity\\Media\\Media', 10 => 'AppBundle\\Entity\\Media\\Gallery', 11 => 'AppBundle\\Entity\\Media\\GalleryHasMedia', 12 => 'AppBundle\\Entity\\Commerce\\Customer', 13 => 'AppBundle\\Entity\\Commerce\\Address', 14 => 'AppBundle\\Entity\\Commerce\\Invoice', 15 => 'AppBundle\\Entity\\Commerce\\Order', 16 => 'AppBundle\\Entity\\Commerce\\OrderElement', 17 => 'AppBundle\\Entity\\Commerce\\Product', 19 => 'AppBundle\\Entity\\Commerce\\ProductCategory', 20 => 'AppBundle\\Entity\\Commerce\\ProductCollection', 21 => 'AppBundle\\Entity\\Commerce\\Delivery', 22 => 'AppBundle\\Entity\\Comment\\Comment', 23 => 'AppBundle\\Entity\\Comment\\Thread', 24 => 'AppBundle\\Entity\\Classification\\Category', 25 => 'AppBundle\\Entity\\Classification\\Tag', 26 => 'AppBundle\\Entity\\Classification\\Collection', 27 => 'AppBundle\\Entity\\Classification\\Context', 28 => 'AppBundle\\Entity\\Notification\\Message', 29 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Car', 30 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Engine', 31 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Color', 32 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Material', 33 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Inspection'));
    ...
    {
        return $this->services['sonata.address.manager'] = new \Sonata\CustomerBundle\Entity\AddressManager('AppBundle\\Entity\\Commerce\\Address', $this->get('doctrine'));
    }
    protected function getSonata_Admin_Audit_ManagerService()
    {
        ...
        $instance->setReader('sonata.admin.audit.orm.reader', array(0 => 'AppBundle\\Entity\\User\\User', 1 => 'AppBundle\\Entity\\User\\Group', 2 => 'AppBundle\\Entity\\Page\\Page', 3 => 'AppBundle\\Entity\\Page\\Block', 5 => 'AppBundle\\Entity\\Page\\Snapshot', 6 => 'AppBundle\\Entity\\Page\\Site', 7 => 'AppBundle\\Entity\\News\\Post', 8 => 'AppBundle\\Entity\\News\\Comment', 9 => 'AppBundle\\Entity\\Media\\Media', 10 => 'AppBundle\\Entity\\Media\\Gallery', 11 => 'AppBundle\\Entity\\Media\\GalleryHasMedia', 12 => 'AppBundle\\Entity\\Commerce\\Customer', 13 => 'AppBundle\\Entity\\Commerce\\Address', 14 => 'AppBundle\\Entity\\Commerce\\Invoice', 15 => 'AppBundle\\Entity\\Commerce\\Order', 16 => 'AppBundle\\Entity\\Commerce\\OrderElement', 17 => 'AppBundle\\Entity\\Commerce\\Product', 19 => 'AppBundle\\Entity\\Commerce\\ProductCategory', 20 => 'AppBundle\\Entity\\Commerce\\ProductCollection', 21 => 'AppBundle\\Entity\\Commerce\\Delivery', 22 => 'AppBundle\\Entity\\Comment\\Comment', 23 => 'AppBundle\\Entity\\Comment\\Thread', 24 => 'AppBundle\\Entity\\Classification\\Category', 25 => 'AppBundle\\Entity\\Classification\\Tag', 26 => 'AppBundle\\Entity\\Classification\\Collection', 27 => 'AppBundle\\Entity\\Classification\\Context', 28 => 'AppBundle\\Entity\\Notification\\Message', 29 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Car', 30 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Engine', 31 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Color', 32 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Material', 33 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Inspection'));
        return $instance;
    }
    ...
    {
        return $this->services['sonata.admin.form.extension.field'] = new \Sonata\AdminBundle\Form\Extension\Field\Type\FormTypeFieldExtension(array('email' => '', 'textarea' => '', 'text' => '', 'choice' => '', 'integer' => '', 'datetime' => 'sonata-medium-date', 'date' => 'sonata-medium-date'), array('html5_validate' => false, 'pager_links' => 5, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'use_bootlint' => false, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'javascripts' => array(0 => 'assetic/sonata_admin_js.js', 1 => 'assetic/sonata_jqueryui_js.js', 2 => 'assetic/sonata_formatter_js.js', 3 => 'bundles/sonataformatter/vendor/ckeditor/ckeditor.js'), 'stylesheets' => array(0 => 'assetic/sonata_admin_css.css', 1 => 'assetic/sonata_formatter_css.css', 2 => 'assetic/sonata_jqueryui_css.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css')));
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Sonata Project', '/bundles/sonataadmin/logo_title.png', array('html5_validate' => false, 'pager_links' => 5, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'use_bootlint' => false, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'javascripts' => array(0 => 'assetic/sonata_admin_js.js', 1 => 'assetic/sonata_jqueryui_js.js', 2 => 'assetic/sonata_formatter_js.js', 3 => 'bundles/sonataformatter/vendor/ckeditor/ckeditor.js'), 'stylesheets' => array(0 => 'assetic/sonata_admin_css.css', 1 => 'assetic/sonata_formatter_css.css', 2 => 'assetic/sonata_jqueryui_css.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css')), array());
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'sonata.page.admin.page', 3 => 'sonata.page.admin.block', 4 => 'sonata.page.admin.shared_block', 5 => 'sonata.page.admin.snapshot', 6 => 'sonata.page.admin.site', 7 => 'sonata.news.admin.post', 8 => 'sonata.news.admin.comment', 9 => 'sonata.media.admin.media', 10 => 'sonata.media.admin.gallery', 11 => 'sonata.media.admin.gallery_has_media', 12 => 'sonata.customer.admin.customer', 13 => 'sonata.customer.admin.address', 14 => 'sonata.invoice.admin.invoice', 15 => 'sonata.order.admin.order', 16 => 'sonata.order.admin.order_element', 17 => 'sonata.product.admin.product', 18 => 'sonata.product.admin.product.variation', 19 => 'sonata.product.admin.product.category', 20 => 'sonata.product.admin.product.collection', 21 => 'sonata.product.admin.delivery', 22 => 'sonata.comment.admin.comment', 23 => 'sonata.comment.admin.thread', 24 => 'sonata.classification.admin.category', 25 => 'sonata.classification.admin.tag', 26 => 'sonata.classification.admin.collection', 27 => 'sonata.classification.admin.context', 28 => 'sonata.notification.admin.message', 29 => 'sonata.demo.admin.car', 30 => 'sonata.demo.admin.engine', 31 => 'sonata.demo.admin.color', 32 => 'sonata.demo.admin.material', 33 => 'sonata.demo.admin.inspection'));
        $instance->setAdminGroups(array('sonata.admin.group.content' => array('label' => 'sonata_content', 'label_catalogue' => 'SonataDemoBundle', 'icon' => '<i class="fa fa-th"></i>', 'items' => array(0 => array('admin' => 'sonata.news.admin.comment', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.news.admin.post', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.media.admin.media', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.media.admin.gallery', 'label' => '', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'sonata.comment.admin.thread', 'label' => '', 'route' => '', 'route_params' => array())), 'item_adds' => array(), 'roles' => array()), 'sonata.admin.group.ecommerce' => array('label' => 'sonata_ecommerce', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-dollar"></i>', 'items' => array(0 => array('admin' => 'sonata.customer.admin.customer', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.invoice.admin.invoice', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.order.admin.order', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.product.admin.product', 'label' => '', 'route' => '', 'route_params' => array())), 'item_adds' => array(), 'roles' => array()), 'sonata.admin.group.classification' => array('label' => 'sonata_classification', 'label_catalogue' => 'SonataClassificationBundle', 'icon' => '<i class="fa fa-sitemap"></i>', 'items' => array(0 => array('admin' => 'sonata.classification.admin.category', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.classification.admin.tag', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.classification.admin.collection', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.classification.admin.context', 'label' => '', 'route' => '', 'route_params' => array())), 'item_adds' => array(), 'roles' => array()), 'sonata.admin.group.site_builder' => array('label' => 'Site Builder', 'label_catalogue' => 'SonataDemoBundle', 'icon' => '<i class="fa fa-puzzle-piece"></i>', 'items' => array(0 => array('admin' => 'sonata.page.admin.page', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.page.admin.site', 'label' => '', 'route' => '', 'route_params' => array())), 'item_adds' => array(), 'roles' => array()), 'sonata.admin.group.administration' => array('label' => 'sonata_administration', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-cogs"></i>', 'items' => array(0 => array('admin' => 'sonata.user.admin.user', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.user.admin.group', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.page.admin.site', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.notification.admin.message', 'label' => '', 'route' => '', 'route_params' => array())), 'item_adds' => array(), 'roles' => array()), 'sonata.admin.group.demo' => array('label' => 'Demo', 'icon' => '<i class="fa fa-play-circle"></i>', 'items' => array(0 => array('admin' => 'sonata.demo.admin.car', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.demo.admin.engine', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.demo.admin.color', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.demo.admin.material', 'label' => '', 'route' => '', 'route_params' => array())), 'item_adds' => array(), 'roles' => array(), 'label_catalogue' => 'SonataAdminBundle')));
        $instance->setAdminClasses(array('AppBundle\\Entity\\User\\User' => array(0 => 'sonata.user.admin.user'), 'AppBundle\\Entity\\User\\Group' => array(0 => 'sonata.user.admin.group'), 'AppBundle\\Entity\\Page\\Page' => array(0 => 'sonata.page.admin.page'), 'AppBundle\\Entity\\Page\\Block' => array(0 => 'sonata.page.admin.block', 1 => 'sonata.page.admin.shared_block'), 'AppBundle\\Entity\\Page\\Snapshot' => array(0 => 'sonata.page.admin.snapshot'), 'AppBundle\\Entity\\Page\\Site' => array(0 => 'sonata.page.admin.site'), 'AppBundle\\Entity\\News\\Post' => array(0 => 'sonata.news.admin.post'), 'AppBundle\\Entity\\News\\Comment' => array(0 => 'sonata.news.admin.comment'), 'AppBundle\\Entity\\Media\\Media' => array(0 => 'sonata.media.admin.media'), 'AppBundle\\Entity\\Media\\Gallery' => array(0 => 'sonata.media.admin.gallery'), 'AppBundle\\Entity\\Media\\GalleryHasMedia' => array(0 => 'sonata.media.admin.gallery_has_media'), 'AppBundle\\Entity\\Commerce\\Customer' => array(0 => 'sonata.customer.admin.customer'), 'AppBundle\\Entity\\Commerce\\Address' => array(0 => 'sonata.customer.admin.address'), 'AppBundle\\Entity\\Commerce\\Invoice' => array(0 => 'sonata.invoice.admin.invoice'), 'AppBundle\\Entity\\Commerce\\Order' => array(0 => 'sonata.order.admin.order'), 'AppBundle\\Entity\\Commerce\\OrderElement' => array(0 => 'sonata.order.admin.order_element'), 'AppBundle\\Entity\\Commerce\\Product' => array(0 => 'sonata.product.admin.product', 1 => 'sonata.product.admin.product.variation'), 'AppBundle\\Entity\\Commerce\\ProductCategory' => array(0 => 'sonata.product.admin.product.category'), 'AppBundle\\Entity\\Commerce\\ProductCollection' => array(0 => 'sonata.product.admin.product.collection'), 'AppBundle\\Entity\\Commerce\\Delivery' => array(0 => 'sonata.product.admin.delivery'), 'AppBundle\\Entity\\Comment\\Comment' => array(0 => 'sonata.comment.admin.comment'), 'AppBundle\\Entity\\Comment\\Thread' => array(0 => 'sonata.comment.admin.thread'), 'AppBundle\\Entity\\Classification\\Category' => array(0 => 'sonata.classification.admin.category'), 'AppBundle\\Entity\\Classification\\Tag' => array(0 => 'sonata.classification.admin.tag'), 'AppBundle\\Entity\\Classification\\Collection' => array(0 => 'sonata.classification.admin.collection'), 'AppBundle\\Entity\\Classification\\Context' => array(0 => 'sonata.classification.admin.context'), 'AppBundle\\Entity\\Notification\\Message' => array(0 => 'sonata.notification.admin.message'), 'Sonata\\Bundle\\DemoBundle\\Entity\\Car' => array(0 => 'sonata.demo.admin.car'), 'Sonata\\Bundle\\DemoBundle\\Entity\\Engine' => array(0 => 'sonata.demo.admin.engine'), 'Sonata\\Bundle\\DemoBundle\\Entity\\Color' => array(0 => 'sonata.demo.admin.color'), 'Sonata\\Bundle\\DemoBundle\\Entity\\Material' => array(0 => 'sonata.demo.admin.material'), 'Sonata\\Bundle\\DemoBundle\\Entity\\Inspection' => array(0 => 'sonata.demo.admin.inspection')));
        return $instance;
    }
    ...
    {
        return $this->services['sonata.admin.twig.extension'] = new \Sonata\AdminBundle\Twig\Extension\SonataAdminExtension($this->get('sonata.admin.pool'), $this->get('cmf_routing.router'), $this->get('knp_menu.helper'), $this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sonata.basket.api.form.type.basket'] = new \Sonata\BasketBundle\Form\ApiBasketType('AppBundle\\Entity\\Commerce\\Basket', $this->get('sonata.price.currency.form_type'));
    }
    protected function getSonata_Basket_Api_Form_Type_Basket_Element_ParentService()
    {
        return $this->services['sonata.basket.api.form.type.basket.element.parent'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_basket_api_form_basket_element_parent', 'AppBundle\\Entity\\Commerce\\BasketElement', 'sonata_api_write');
    }
    protected function getSonata_Basket_Api_Form_Type_Basket_ParentService()
    {
        return $this->services['sonata.basket.api.form.type.basket.parent'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_basket_api_form_basket_parent', 'AppBundle\\Entity\\Commerce\\Basket', 'sonata_api_write');
    }
    protected function getSonata_Basket_Api_Form_Type_BasketElementService()
    {
        return $this->services['sonata.basket.api.form.type.basket_element'] = new \Sonata\BasketBundle\Form\ApiBasketElementType('AppBundle\\Entity\\Commerce\\BasketElement');
    }
    ...
    {
        return $this->services['sonata.basket.form.type.address'] = new \Sonata\BasketBundle\Form\AddressType('AppBundle\\Entity\\Commerce\\Address', $this->get('sonata.basket'));
    }
    ...
    {
        return $this->services['sonata.basket.manager'] = new \Sonata\Component\Basket\BasketManager('AppBundle\\Entity\\Commerce\\Basket', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.basket_element.manager'] = new \Sonata\Component\Basket\BasketElementManager('AppBundle\\Entity\\Commerce\\BasketElement', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.stats', 1 => 'sonata.admin.block.admin_list', 2 => 'sonata.admin.block.search_result', 3 => 'sonata.block.service.text', 4 => 'sonata.block.service.container', 5 => 'sonata.block.service.rss', 6 => 'sonata.block.service.menu', 7 => 'sonata.block.service.template', 8 => 'sonata.page.block.container', 9 => 'sonata.page.block.children_pages', 10 => 'sonata.page.block.breadcrumb', 11 => 'sonata.media.block.media', 12 => 'sonata.media.block.gallery', 13 => 'sonata.media.block.feature_media', 14 => 'sonata.news.block.recent_comments', 15 => 'sonata.news.block.recent_posts', 16 => 'sonata.order.block.recent_orders', 17 => 'sonata.product.block.recent_products', 18 => 'sonata.product.block.similar_products', 19 => 'sonata.product.block.categories_menu', 20 => 'sonata.product.block.filters_menu', 21 => 'sonata.product.block.variations_form', 22 => 'sonata.customer.block.recent_customers', 23 => 'sonata.basket.block.nb_items', 24 => 'sonata.timeline.block.timeline', 25 => 'sonata.user.block.account', 26 => 'sonata.user.block.menu', 27 => 'sonata.seo.block.email.share_button', 28 => 'sonata.seo.block.facebook.like_box', 29 => 'sonata.seo.block.facebook.like_button', 30 => 'sonata.seo.block.facebook.send_button', 31 => 'sonata.seo.block.facebook.share_button', 32 => 'sonata.seo.block.pinterest.pin_button', 33 => 'sonata.seo.block.twitter.share_button', 34 => 'sonata.seo.block.twitter.follow_button', 35 => 'sonata.seo.block.twitter.hashtag_button', 36 => 'sonata.seo.block.twitter.mention_button', 37 => 'sonata.seo.block.twitter.embed', 38 => 'sonata.demo.block.newsletter', 39 => 'sonata.formatter.block.formatter', 40 => 'sonata.seo.block.breadcrumb.homepage'));
    }
    ...
    {
        $instance = new \Sonata\ClassificationBundle\Admin\CollectionAdmin('sonata.classification.admin.collection', 'AppBundle\\Entity\\Classification\\Collection', 'SonataAdminBundle:CRUD');
        $instance->setTranslationDomain('SonataClassificationBundle');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    {
        $instance = new \Sonata\ClassificationBundle\Admin\TagAdmin('sonata.classification.admin.tag', 'AppBundle\\Entity\\Classification\\Tag', 'SonataAdminBundle:CRUD');
        $instance->setTranslationDomain('SonataClassificationBundle');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    {
        return $this->services['sonata.classification.api.form.type.category'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_classification_api_form_category', 'AppBundle\\Entity\\Classification\\Category', 'sonata_api_write');
    }
    protected function getSonata_Classification_Api_Form_Type_CollectionService()
    {
        return $this->services['sonata.classification.api.form.type.collection'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_classification_api_form_collection', 'AppBundle\\Entity\\Classification\\Collection', 'sonata_api_write');
    }
    protected function getSonata_Classification_Api_Form_Type_ContextService()
    {
        return $this->services['sonata.classification.api.form.type.context'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_classification_api_form_context', 'AppBundle\\Entity\\Classification\\Context', 'sonata_api_write', true);
    }
    protected function getSonata_Classification_Api_Form_Type_TagService()
    {
        return $this->services['sonata.classification.api.form.type.tag'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_classification_api_form_tag', 'AppBundle\\Entity\\Classification\\Tag', 'sonata_api_write');
    }
    ...
    {
        $instance = new \Sonata\CommentBundle\Admin\Entity\CommentAdmin('sonata.comment.admin.comment', 'AppBundle\\Entity\\Comment\\Comment', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Comment_Admin_ThreadService()
    {
        ...
        $p = new \Sonata\CommentBundle\Admin\Entity\CommentAdmin('sonata.comment.admin.comment', 'AppBundle\\Entity\\Comment\\Comment', 'SonataAdminBundle:CRUD');
        ...
        $instance = new \Sonata\CommentBundle\Admin\Entity\ThreadAdmin('sonata.comment.admin.thread', 'AppBundle\\Entity\\Comment\\Thread', 'SonataAdminBundle:CRUD');
        $instance->setTranslationDomain('SonataCommentBundle');
        $instance->addChild($p);
    ...
    {
        return $this->services['sonata.comment.form.comment_status_type'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\Comment\\Comment', 'getStateList', 'sonata_comment_status');
    }
    ...
    {
        return $this->services['sonata.comment.manager.comment'] = new \Sonata\CommentBundle\Manager\CommentManager($this->get('event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'AppBundle\\Entity\\Comment\\Comment');
    }
    protected function getSonata_Comment_Manager_ThreadService()
    {
        return $this->services['sonata.comment.manager.thread'] = new \Sonata\CommentBundle\Manager\ThreadManager($this->get('sonata.comment.manager.comment'), $this->get('event_dispatcher'), $this->get('fos_comment.entity_manager'), 'AppBundle\\Entity\\Comment\\Thread');
    }
    ...
    {
        $instance = new \Sonata\CustomerBundle\Admin\AddressAdmin('sonata.customer.admin.address', 'AppBundle\\Entity\\Commerce\\Address', 'SonataAdminBundle:CRUD');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
    ...
    protected function getSonata_Customer_Admin_CustomerService()
    {
        ...
        $q = new \Sonata\CustomerBundle\Admin\AddressAdmin('sonata.customer.admin.address', 'AppBundle\\Entity\\Commerce\\Address', 'SonataAdminBundle:CRUD');
        ...
        $r = new \Sonata\OrderBundle\Admin\OrderElementAdmin('sonata.order.admin.order_element', 'AppBundle\\Entity\\Commerce\\OrderElement', 'SonataAdminBundle:CRUD');
        ...
        $s = new \Sonata\OrderBundle\Admin\OrderAdmin('sonata.order.admin.order', 'AppBundle\\Entity\\Commerce\\Order', 'SonataOrderBundle:OrderCRUD');
        $s->addChild($r);
        ...
        $instance = new \Sonata\CustomerBundle\Admin\CustomerAdmin('sonata.customer.admin.customer', 'AppBundle\\Entity\\Commerce\\Customer', 'SonataAdminBundle:CRUD');
        $instance->addChild($q);
        $instance->addChild($s);
        $instance->setLabelTranslatorStrategy($a);
        $instance->setManagerType('orm');
    ...
    {
        return $this->services['sonata.customer.api.form.type.address'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_customer_api_form_address', 'AppBundle\\Entity\\Commerce\\Address', 'sonata_api_write');
    }
    protected function getSonata_Customer_Api_Form_Type_CustomerService()
    {
        return $this->services['sonata.customer.api.form.type.customer'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_customer_api_form_customer', 'AppBundle\\Entity\\Commerce\\Customer', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.customer.block.recent_customers'] = new \Sonata\CustomerBundle\Block\RecentCustomersBlockService('sonata.customer.block.recent_customers', $this->get('templating'), $this->get('sonata.customer.manager'), $this->get('sonata.admin.pool', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sonata.customer.form.address_type'] = new \Sonata\CustomerBundle\Form\AddressType('AppBundle\\Entity\\Commerce\\Address', 'getTypesList', 'sonata_customer_address', $this->get('sonata.basket'));
    }
    protected function getSonata_Customer_Form_AddressTypesTypeService()
    {
        return $this->services['sonata.customer.form.address_types_type'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\Commerce\\Address', 'getTypesList', 'sonata_customer_address_types');
    }
    protected function getSonata_Customer_ManagerService()
    {
        return $this->services['sonata.customer.manager'] = new \Sonata\CustomerBundle\Entity\CustomerManager('AppBundle\\Entity\\Commerce\\Customer', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.delivery.manager'] = new \Sonata\ProductBundle\Entity\DeliveryManager('AppBundle\\Entity\\Commerce\\Delivery', $this->get('doctrine'));
    }
    ...
    protected function getSonata_Delivery_PoolService()
    {
        ...
        $instance->addMethod($this->get('app.delivery.take_away'));
        return $instance;
    }
    ...
    protected function getSonata_EasyExtends_Doctrine_MapperService()
    {
        ...
        $instance->addAssociation('AppBundle\\Entity\\User\\User', 'mapManyToMany', array(0 => array('fieldName' => 'groups', 'targetEntity' => 'AppBundle\\Entity\\User\\Group', 'cascade' => array(), 'joinTable' => array('name' => 'fos_user_user_group', 'joinColumns' => array(0 => array('name' => 'user_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'inverseJoinColumns' => array(0 => array('name' => 'group_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE'))))));
        $instance->addAssociation('AppBundle\\Entity\\Page\\Page', 'mapOneToMany', array(0 => array('fieldName' => 'children', 'targetEntity' => 'AppBundle\\Entity\\Page\\Page', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'parent', 'orphanRemoval' => false, 'orderBy' => array('position' => 'ASC')), 1 => array('fieldName' => 'blocks', 'targetEntity' => 'AppBundle\\Entity\\Page\\Block', 'cascade' => array(0 => 'remove', 1 => 'persist', 2 => 'refresh', 3 => 'merge', 4 => 'detach'), 'mappedBy' => 'page', 'orphanRemoval' => false, 'orderBy' => array('position' => 'ASC')), 2 => array('fieldName' => 'sources', 'targetEntity' => 'AppBundle\\Entity\\Page\\Page', 'cascade' => array(), 'mappedBy' => 'target', 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Page\\Page', 'mapManyToOne', array(0 => array('fieldName' => 'site', 'targetEntity' => 'AppBundle\\Entity\\Page\\Site', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'site_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'parent', 'targetEntity' => 'AppBundle\\Entity\\Page\\Page', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'children', 'joinColumns' => array(0 => array('name' => 'parent_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false), 2 => array('fieldName' => 'target', 'targetEntity' => 'AppBundle\\Entity\\Page\\Page', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'sources', 'joinColumns' => array(0 => array('name' => 'target_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Page\\Block', 'mapOneToMany', array(0 => array('fieldName' => 'children', 'targetEntity' => 'AppBundle\\Entity\\Page\\Block', 'cascade' => array(0 => 'remove', 1 => 'persist'), 'mappedBy' => 'parent', 'orphanRemoval' => true, 'orderBy' => array('position' => 'ASC'))));
        $instance->addAssociation('AppBundle\\Entity\\Page\\Block', 'mapManyToOne', array(0 => array('fieldName' => 'parent', 'targetEntity' => 'AppBundle\\Entity\\Page\\Block', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => 'children', 'joinColumns' => array(0 => array('name' => 'parent_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'page', 'targetEntity' => 'AppBundle\\Entity\\Page\\Page', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'blocks', 'joinColumns' => array(0 => array('name' => 'page_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Page\\Snapshot', 'mapManyToOne', array(0 => array('fieldName' => 'site', 'targetEntity' => 'AppBundle\\Entity\\Page\\Site', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'site_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'page', 'targetEntity' => 'AppBundle\\Entity\\Page\\Page', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'page_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\News\\Post', 'mapOneToMany', array(0 => array('fieldName' => 'comments', 'targetEntity' => 'AppBundle\\Entity\\News\\Comment', 'cascade' => array(0 => 'remove', 1 => 'persist'), 'mappedBy' => 'post', 'orphanRemoval' => true, 'orderBy' => array('createdAt' => 'DESC'))));
        $instance->addAssociation('AppBundle\\Entity\\News\\Post', 'mapManyToOne', array(0 => array('fieldName' => 'image', 'targetEntity' => 'AppBundle\\Entity\\Media\\Media', 'cascade' => array(0 => 'remove', 1 => 'persist', 2 => 'refresh', 3 => 'merge', 4 => 'detach'), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'image_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false), 1 => array('fieldName' => 'author', 'targetEntity' => 'AppBundle\\Entity\\User\\User', 'cascade' => array(1 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'author_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false), 2 => array('fieldName' => 'collection', 'targetEntity' => 'AppBundle\\Entity\\Classification\\Collection', 'cascade' => array(1 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'collection_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\News\\Post', 'mapManyToMany', array(0 => array('fieldName' => 'tags', 'targetEntity' => 'AppBundle\\Entity\\Classification\\Tag', 'cascade' => array(1 => 'persist'), 'joinTable' => array('name' => 'news__post_tag', 'joinColumns' => array(0 => array('name' => 'post_id', 'referencedColumnName' => 'id')), 'inverseJoinColumns' => array(0 => array('name' => 'tag_id', 'referencedColumnName' => 'id'))))));
        $instance->addAssociation('AppBundle\\Entity\\News\\Comment', 'mapManyToOne', array(0 => array('fieldName' => 'post', 'targetEntity' => 'AppBundle\\Entity\\News\\Post', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => 'comments', 'joinColumns' => array(0 => array('name' => 'post_id', 'referencedColumnName' => 'id', 'nullable' => false)), 'orphanRemoval' => false)));
        ...
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Basket', 'mapManyToOne', array(0 => array('fieldName' => 'customer', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Customer', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'customer_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE', 'unique' => true)), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Basket', 'mapOneToMany', array(0 => array('fieldName' => 'basketElements', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\BasketElement', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'basket', 'orphanRemoval' => true)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\BasketElement', 'mapManyToOne', array(0 => array('fieldName' => 'basket', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Basket', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => 'basketElements', 'joinColumns' => array(0 => array('name' => 'basket_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Customer', 'mapOneToMany', array(0 => array('fieldName' => 'addresses', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Address', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'customer', 'orphanRemoval' => false), 1 => array('fieldName' => 'orders', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Order', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'customer', 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Customer', 'mapManyToOne', array(0 => array('fieldName' => 'user', 'targetEntity' => 'AppBundle\\Entity\\User\\User', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'customers', 'joinColumns' => array(0 => array('name' => 'user_id', 'referencedColumnName' => 'id', 'onDelete' => 'SET NULL')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Address', 'mapManyToOne', array(0 => array('fieldName' => 'customer', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Customer', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'addresses', 'joinColumns' => array(0 => array('name' => 'customer_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Invoice', 'mapManyToOne', array(0 => array('fieldName' => 'customer', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Customer', 'cascade' => array(0 => 'persist', 1 => 'refresh', 2 => 'merge', 3 => 'detach'), 'mappedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'customer_id', 'referencedColumnName' => 'id', 'onDelete' => 'SET NULL')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Invoice', 'mapOneToMany', array(0 => array('fieldName' => 'invoiceElements', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\InvoiceElement', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'invoice', 'orphanRemoval' => true)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\InvoiceElement', 'mapManyToOne', array(0 => array('fieldName' => 'invoice', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Invoice', 'cascade' => array(0 => 'persist', 1 => 'refresh', 2 => 'merge', 3 => 'detach'), 'mappedBy' => NULL, 'inversedBy' => 'invoiceElements', 'joinColumns' => array(0 => array('name' => 'invoice_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'orderElement', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\OrderElement', 'cascade' => array(), 'joinColumns' => array(0 => array('name' => 'order_element_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')))));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Order', 'mapOneToMany', array(0 => array('fieldName' => 'orderElements', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\OrderElement', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'order', 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Order', 'mapManyToOne', array(0 => array('fieldName' => 'customer', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Customer', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => 'orders', 'joinColumns' => array(0 => array('name' => 'customer_id', 'referencedColumnName' => 'id', 'onDelete' => 'SET NULL')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\OrderElement', 'mapManyToOne', array(0 => array('fieldName' => 'order', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Order', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'order_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Transaction', 'mapManyToOne', array(0 => array('fieldName' => 'order', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Order', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'order_id', 'referencedColumnName' => 'id', 'onDelete' => 'SET NULL')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Delivery', 'mapManyToOne', array(0 => array('fieldName' => 'product', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Product', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'deliveries', 'joinColumns' => array(0 => array('name' => 'product_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Package', 'mapManyToOne', array(0 => array('fieldName' => 'product', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Product', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'packages', 'joinColumns' => array(0 => array('name' => 'product_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\ProductCategory', 'mapManyToOne', array(0 => array('fieldName' => 'product', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Product', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'productCategories', 'joinColumns' => array(0 => array('name' => 'product_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE', 'onUpdate' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'category', 'targetEntity' => 'AppBundle\\Entity\\Classification\\Category', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'category_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE', 'onUpdate' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\ProductCollection', 'mapManyToOne', array(0 => array('fieldName' => 'product', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Product', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'productCollections', 'joinColumns' => array(0 => array('name' => 'product_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE', 'onUpdate' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'collection', 'targetEntity' => 'AppBundle\\Entity\\Classification\\Collection', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'productCollection', 'joinColumns' => array(0 => array('name' => 'collection_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE', 'onUpdate' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Product', 'mapOneToMany', array(0 => array('fieldName' => 'packages', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Package', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'product', 'orphanRemoval' => false), 1 => array('fieldName' => 'deliveries', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Delivery', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'product', 'orphanRemoval' => false), 2 => array('fieldName' => 'productCategories', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\ProductCategory', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'product', 'orphanRemoval' => false), 3 => array('fieldName' => 'productCollections', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\ProductCollection', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'product', 'orphanRemoval' => false), 4 => array('fieldName' => 'variations', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Product', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'parent', 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Commerce\\Product', 'mapManyToOne', array(0 => array('fieldName' => 'image', 'targetEntity' => 'AppBundle\\Entity\\Media\\Media', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'image_id', 'referencedColumnName' => 'id', 'onDelete' => 'SET NULL')), 'orphanRemoval' => false), 1 => array('fieldName' => 'gallery', 'targetEntity' => 'AppBundle\\Entity\\Media\\Gallery', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'gallery_id', 'referencedColumnName' => 'id', 'onDelete' => 'SET NULL')), 'orphanRemoval' => false), 2 => array('fieldName' => 'parent', 'targetEntity' => 'AppBundle\\Entity\\Commerce\\Product', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'variations', 'joinColumns' => array(0 => array('name' => 'parent_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Comment\\Comment', 'mapManyToOne', array(0 => array('fieldName' => 'thread', 'targetEntity' => 'AppBundle\\Entity\\Comment\\Thread', 'cascade' => array())));
        $instance->addAssociation('AppBundle\\Entity\\Comment\\Thread', 'mapManyToOne', array(0 => array('fieldName' => 'category', 'targetEntity' => 'AppBundle\\Entity\\Classification\\Category', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'category_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE', 'onUpdate' => 'CASCADE')), 'orphanRemoval' => false)));
        ...
        $instance->addAssociation('AppBundle\\Entity\\Timeline\\Timeline', 'mapManyToOne', array(0 => array('fieldName' => 'action', 'targetEntity' => 'AppBundle\\Entity\\Timeline\\Action', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => 'timelines', 'joinColumns' => array(0 => array('name' => 'action_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false), 1 => array('fieldName' => 'subject', 'targetEntity' => 'AppBundle\\Entity\\Timeline\\Component', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'subject_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addAssociation('AppBundle\\Entity\\Timeline\\Action', 'mapOneToMany', array(0 => array('fieldName' => 'actionComponents', 'targetEntity' => 'AppBundle\\Entity\\Timeline\\ActionComponent', 'cascade' => array(1 => 'persist'), 'mappedBy' => 'action'), 1 => array('fieldName' => 'timelines', 'targetEntity' => 'AppBundle\\Entity\\Timeline\\Timeline', 'cascade' => array(), 'mappedBy' => 'action')));
        $instance->addAssociation('AppBundle\\Entity\\Timeline\\ActionComponent', 'mapManyToOne', array(0 => array('fieldName' => 'action', 'targetEntity' => 'AppBundle\\Entity\\Timeline\\Action', 'cascade' => array(), 'mappedBy' => NULL, 'inversedBy' => 'actionComponents', 'joinColumns' => array(0 => array('name' => 'action_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false), 1 => array('fieldName' => 'component', 'targetEntity' => 'AppBundle\\Entity\\Timeline\\Component', 'cascade' => array(), 'mappedBy' => NULL, 'joinColumns' => array(0 => array('name' => 'component_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'orphanRemoval' => false)));
        $instance->addIndex('AppBundle\\Entity\\Page\\Snapshot', 'idx_snapshot_dates_enabled', array(0 => 'publication_date_start', 1 => 'publication_date_end', 2 => 'enabled'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\OrderElement', 'product_type', array(0 => 'product_type'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\OrderElement', 'order_element_status', array(0 => 'status'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\Order', 'order_status', array(0 => 'status'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\Order', 'payment_status', array(0 => 'payment_status'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\Transaction', 'status_code', array(0 => 'status_code'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\Transaction', 'state', array(0 => 'state'));
        $instance->addIndex('AppBundle\\Entity\\Commerce\\Product', 'enabled', array(0 => 'enabled'));
        $instance->addIndex('AppBundle\\Entity\\Notification\\Message', 'idx_state', array(0 => 'state'));
        $instance->addIndex('AppBundle\\Entity\\Notification\\Message', 'idx_created_at', array(0 => 'created_at'));
    ...
    {
        return $this->services['sonata.ecommerce_demo.product.goodie.manager'] = new \Sonata\ProductBundle\Entity\ProductManager('Sonata\\Bundle\\DemoBundle\\Entity\\Goodie', $this->get('doctrine'));
    }
    protected function getSonata_EcommerceDemo_Product_Goodie_TypeService()
    {
        $this->services['sonata.ecommerce_demo.product.goodie.type'] = $instance = new \Sonata\Bundle\DemoBundle\Provider\GoodieProductProvider($this->get('jms_serializer'));
        ...
        $instance->setOrderElementClassName('AppBundle\\Entity\\Commerce\\OrderElement');
        $instance->setEventDispatcher($this->get('event_dispatcher'));
        return $instance;
    }
    protected function getSonata_EcommerceDemo_Product_Travel_ManagerService()
    {
        return $this->services['sonata.ecommerce_demo.product.travel.manager'] = new \Sonata\ProductBundle\Entity\ProductManager('Sonata\\Bundle\\DemoBundle\\Entity\\Travel', $this->get('doctrine'));
    }
    protected function getSonata_EcommerceDemo_Product_Travel_TypeService()
    {
        $this->services['sonata.ecommerce_demo.product.travel.type'] = $instance = new \Sonata\Bundle\DemoBundle\Provider\TravelProductProvider($this->get('jms_serializer'));
    ...
    {
        $instance = new \Sonata\InvoiceBundle\Admin\InvoiceAdmin('sonata.invoice.admin.invoice', 'AppBundle\\Entity\\Commerce\\Invoice', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.invoice.form.status_type'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\Commerce\\Invoice', 'getStatusList', 'sonata_invoice_status');
    }
    protected function getSonata_Invoice_ManagerService()
    {
        return $this->services['sonata.invoice.manager'] = new \Sonata\InvoiceBundle\Entity\InvoiceManager('AppBundle\\Entity\\Commerce\\Invoice', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.invoice_element.manager'] = new \Sonata\InvoiceBundle\Entity\InvoiceElementManager('AppBundle\\Entity\\Commerce\\InvoiceElement', $this->get('doctrine'));
    }
    ...
    {
        $instance = new \Sonata\MediaBundle\Admin\ORM\MediaAdmin('sonata.media.admin.media', 'AppBundle\\Entity\\Media\\Media', 'SonataMediaBundle:MediaAdmin', $this->get('sonata.media.pool'), $this->get('sonata.classification.manager.category'));
    ...
    {
        return $this->services['sonata.media.api.form.type.doctrine.media'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_media_api_form_doctrine_media', 'AppBundle\\Entity\\Media\\Media', 'sonata_api_write');
    }
    protected function getSonata_Media_Api_Form_Type_GalleryService()
    {
        return $this->services['sonata.media.api.form.type.gallery'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_media_api_form_gallery', 'AppBundle\\Entity\\Media\\Gallery', 'sonata_api_write');
    }
    protected function getSonata_Media_Api_Form_Type_GalleryHasMediaService()
    {
        return $this->services['sonata.media.api.form.type.gallery_has_media'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_media_api_form_gallery_has_media', 'AppBundle\\Entity\\Media\\GalleryHasMedia', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.media.cdn.server'] = new \Sonata\MediaBundle\CDN\Server('http://demo.sonata-project.org/uploads/media');
    }
    ...
    {
        return $this->services['sonata.media.extra.pixlr'] = new \Sonata\MediaBundle\Extra\Pixlr('Demo - Sonata Project', '25c97393cf89d082b6540f14e45c1cbc9662331f', $this->get('sonata.media.pool'), $this->get('sonata.media.manager.media'), $this->get('cmf_routing.router'), $this->get('templating'), $this);
    }
    ...
    protected function getSonata_Media_PoolService()
    {
        ...
        $instance->addContext('product_catalog', array(0 => 'sonata.media.provider.image'), array('product_catalog_preview' => array('width' => 100, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true), 'product_catalog_small' => array('width' => 300, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true), 'product_catalog_large' => array('width' => 750, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
    ...
    protected function getSonata_Media_Provider_ImageService()
    {
        ...
        $instance->addFormat('product_catalog_preview', array('width' => 100, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_catalog_small', array('width' => 300, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_catalog_large', array('width' => 750, 'quality' => 100, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->setResizer($this->get('sonata.media.resizer.simple'));
        $instance->addFormat('admin', array('quality' => 90, 'width' => 200, 'format' => 'jpg', 'height' => false, 'constraint' => true));
        return $instance;
    }
    ...
    {
        $instance = new \Sonata\NewsBundle\Admin\CommentAdmin('sonata.news.admin.comment', 'AppBundle\\Entity\\News\\Comment', 'SonataNewsBundle:CommentAdmin');
    ...
    protected function getSonata_News_Admin_PostService()
    {
        ...
        $n = $this->get('sonata.admin.event.extension');
        $o = $this->get('sonata.timeline.admin.extension');
        $p = new \Sonata\NewsBundle\Admin\CommentAdmin('sonata.news.admin.comment', 'AppBundle\\Entity\\News\\Comment', 'SonataNewsBundle:CommentAdmin');
        ...
        $p->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $p->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance = new \Sonata\NewsBundle\Admin\PostAdmin('sonata.news.admin.post', 'AppBundle\\Entity\\News\\Post', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.news.api.form.type.comment'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_news_api_form_comment', 'AppBundle\\Entity\\News\\Comment', 'sonata_api_write');
    }
    protected function getSonata_News_Api_Form_Type_PostService()
    {
        return $this->services['sonata.news.api.form.type.post'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_news_api_form_post', 'AppBundle\\Entity\\News\\Post', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.news.block.recent_comments'] = new \Sonata\NewsBundle\Block\RecentCommentsBlockService('sonata.news.block.recent_comments', $this->get('templating'), $this->get('sonata.news.manager.comment'), $this->get('sonata.admin.pool', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    protected function getSonata_News_Block_RecentPostsService()
    {
        return $this->services['sonata.news.block.recent_posts'] = new \Sonata\NewsBundle\Block\RecentPostsBlockService('sonata.news.block.recent_posts', $this->get('templating'), $this->get('sonata.news.manager.post'), $this->get('sonata.admin.pool', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sonata.news.form.comment.status_type'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\News\\Comment', 'getStatusList', 'sonata_news_comment_status');
    }
    ...
    {
        return $this->services['sonata.news.manager.comment'] = new \Sonata\NewsBundle\Entity\CommentManager('AppBundle\\Entity\\News\\Comment', $this->get('doctrine'), $this->get('sonata.news.manager.post'));
    }
    protected function getSonata_News_Manager_PostService()
    {
        return $this->services['sonata.news.manager.post'] = new \Sonata\NewsBundle\Entity\PostManager('AppBundle\\Entity\\News\\Post', $this->get('doctrine'));
    }
    ...
    {
        $instance = new \Sonata\NotificationBundle\Admin\MessageAdmin('sonata.notification.admin.message', 'AppBundle\\Entity\\Notification\\Message', 'SonataNotificationBundle:MessageAdmin');
    ...
    protected function getSonata_Notification_Api_Form_Type_MessageService()
    {
        return $this->services['sonata.notification.api.form.type.message'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_notification_api_form_message', 'AppBundle\\Entity\\Notification\\Message', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.notification.controller.api.message'] = new \Sonata\NotificationBundle\Controller\Api\MessageController($this->get('sonata.notification.manager.message.default'), $this->get('form.factory'));
    }
    ...
    {
        return $this->services['sonata.notification.erroneous_messages_selector'] = new \Sonata\NotificationBundle\Selector\ErroneousMessagesSelector($this->get('doctrine'), 'AppBundle\\Entity\\Notification\\Message');
    }
    ...
    {
        return $this->services['sonata.notification.manager.message.default'] = new \Sonata\NotificationBundle\Entity\MessageManager('AppBundle\\Entity\\Notification\\Message', $this->get('doctrine'));
    }
    protected function getSonata_Order_Admin_OrderService()
    {
        ...
        $q = new \Sonata\OrderBundle\Admin\OrderElementAdmin('sonata.order.admin.order_element', 'AppBundle\\Entity\\Commerce\\OrderElement', 'SonataAdminBundle:CRUD');
        ...
        $q->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $q->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance = new \Sonata\OrderBundle\Admin\OrderAdmin('sonata.order.admin.order', 'AppBundle\\Entity\\Commerce\\Order', 'SonataOrderBundle:OrderCRUD');
        $instance->addChild($q);
    ...
    {
        $instance = new \Sonata\OrderBundle\Admin\OrderElementAdmin('sonata.order.admin.order_element', 'AppBundle\\Entity\\Commerce\\OrderElement', 'SonataAdminBundle:CRUD');
        $instance->setCurrencyDetector($this->get('sonata.price.currency.detector'));
    ...
    {
        return $this->services['sonata.order.block.recent_orders'] = new \Sonata\OrderBundle\Block\RecentOrdersBlockService('sonata.order.block.recent_orders', $this->get('templating'), $this->get('sonata.order.manager'), $this->get('sonata.customer.manager'), $this->get('security.context'), $this->get('sonata.admin.pool', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sonata.order.form.status_type'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\Commerce\\Order', 'getStatusList', 'sonata_order_status');
    }
    protected function getSonata_Order_ManagerService()
    {
        return $this->services['sonata.order.manager'] = new \Sonata\OrderBundle\Entity\OrderManager('AppBundle\\Entity\\Commerce\\Order', $this->get('doctrine'));
    }
    protected function getSonata_Order_OrderElement_ManagerService()
    {
        return $this->services['sonata.order.order_element.manager'] = new \Sonata\OrderBundle\Entity\OrderElementManager('AppBundle\\Entity\\Commerce\\OrderElement', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.package.manager'] = new \Sonata\ProductBundle\Entity\PackageManager('AppBundle\\Entity\\Commerce\\Package', $this->get('doctrine'));
    }
    protected function getSonata_Page_Admin_BlockService()
    {
        $instance = new \Sonata\PageBundle\Admin\BlockAdmin('sonata.page.admin.block', 'AppBundle\\Entity\\Page\\Block', 'SonataPageBundle:BlockAdmin');
    ...
    protected function getSonata_Page_Admin_PageService()
    {
        ...
        $o = $this->get('sonata.admin.event.extension');
        $p = $this->get('sonata.timeline.admin.extension');
        $q = new \Sonata\PageBundle\Admin\BlockAdmin('sonata.page.admin.block', 'AppBundle\\Entity\\Page\\Block', 'SonataPageBundle:BlockAdmin');
        $q->setCacheManager($a);
        ...
        $q->addExtension($p);
        $q->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $r = new \Sonata\PageBundle\Admin\SnapshotAdmin('sonata.page.admin.snapshot', 'AppBundle\\Entity\\Page\\Snapshot', 'SonataPageBundle:SnapshotAdmin');
        $r->setCacheManager($a);
        ...
        $r->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $r->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance = new \Sonata\PageBundle\Admin\PageAdmin('sonata.page.admin.page', 'AppBundle\\Entity\\Page\\Page', 'SonataPageBundle:PageAdmin');
        $instance->addChild($q);
        $instance->addChild($r);
    ...
    {
        $instance = new \Sonata\PageBundle\Admin\SharedBlockAdmin('sonata.page.admin.shared_block', 'AppBundle\\Entity\\Page\\Block', 'SonataPageBundle:BlockAdmin');
        $instance->setCacheManager($this->get('sonata.cache.manager'));
        $instance->setBlockManager($this->get('sonata.block.manager'));
        $instance->setTranslationDomain('SonataPageBundle');
        $instance->setContainerBlockTypes(array(0 => 'sonata.block.service.container', 1 => 'sonata.page.block.container', 2 => 'cmf.block.container', 3 => 'cmf.block.slideshow'));
    ...
    {
        $instance = new \Sonata\PageBundle\Admin\SiteAdmin('sonata.page.admin.site', 'AppBundle\\Entity\\Page\\Site', 'SonataPageBundle:SiteAdmin', $this->get('sonata.page.route.page.generator'));
        $instance->setTranslationDomain('SonataPageBundle');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    {
        $instance = new \Sonata\PageBundle\Admin\SnapshotAdmin('sonata.page.admin.snapshot', 'AppBundle\\Entity\\Page\\Snapshot', 'SonataPageBundle:SnapshotAdmin');
        $instance->setCacheManager($this->get('sonata.cache.manager'));
        $instance->setTranslationDomain('SonataPageBundle');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
    ...
    {
        return $this->services['sonata.page.api.form.type.block'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_page_api_form_block', 'AppBundle\\Entity\\Page\\Block', 'sonata_api_write');
    }
    protected function getSonata_Page_Api_Form_Type_PageService()
    {
        return $this->services['sonata.page.api.form.type.page'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_page_api_form_page', 'AppBundle\\Entity\\Page\\Page', 'sonata_api_write');
    }
    protected function getSonata_Page_Api_Form_Type_SiteService()
    {
        return $this->services['sonata.page.api.form.type.site'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_page_api_form_site', 'AppBundle\\Entity\\Page\\Site', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.page.manager.block'] = new \Sonata\PageBundle\Entity\BlockManager('AppBundle\\Entity\\Page\\Block', $this->get('doctrine'));
    }
    protected function getSonata_Page_Manager_PageService()
    {
        return $this->services['sonata.page.manager.page'] = new \Sonata\PageBundle\Entity\PageManager('AppBundle\\Entity\\Page\\Page', $this->get('doctrine'), array('templateCode' => 'default', 'enabled' => true, 'routeName' => NULL, 'name' => NULL, 'slug' => NULL, 'url' => NULL, 'requestMethod' => NULL, 'decorate' => true), array('homepage' => array('templateCode' => 'default', 'enabled' => true, 'routeName' => NULL, 'name' => NULL, 'slug' => NULL, 'url' => NULL, 'requestMethod' => NULL, 'decorate' => false)));
    }
    protected function getSonata_Page_Manager_SiteService()
    {
        return $this->services['sonata.page.manager.site'] = new \Sonata\PageBundle\Entity\SiteManager('AppBundle\\Entity\\Page\\Site', $this->get('doctrine'));
    }
    protected function getSonata_Page_Manager_SnapshotService()
    {
        return $this->services['sonata.page.manager.snapshot'] = new \Sonata\PageBundle\Entity\SnapshotManager('AppBundle\\Entity\\Page\\Snapshot', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.payment.form.transaction_status'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\Commerce\\Transaction', 'getStatusList', 'sonata_payment_transaction_status');
    }
    ...
    {
        $instance = new \Sonata\ProductBundle\Admin\DeliveryAdmin('sonata.product.admin.delivery', 'AppBundle\\Entity\\Commerce\\Delivery', 'SonataAdminBundle:CRUD');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
    ...
    protected function getSonata_Product_Admin_ProductService()
    {
        ...
        $r = new \Sonata\ProductBundle\Admin\ProductCategoryAdmin('sonata.product.admin.product.category', 'AppBundle\\Entity\\Commerce\\ProductCategory', 'SonataAdminBundle:CRUD');
        ...
        $r->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $r->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $s = new \Sonata\ProductBundle\Admin\ProductCollectionAdmin('sonata.product.admin.product.collection', 'AppBundle\\Entity\\Commerce\\ProductCollection', 'SonataAdminBundle:CRUD');
        ...
        $s->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $s->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $t = new \Sonata\ProductBundle\Admin\DeliveryAdmin('sonata.product.admin.delivery', 'AppBundle\\Entity\\Commerce\\Delivery', 'SonataAdminBundle:CRUD');
        ...
        $u = new \Sonata\ProductBundle\Admin\ProductVariationAdmin('sonata.product.admin.product.variation', 'AppBundle\\Entity\\Commerce\\Product', 'SonataProductBundle:ProductVariationAdmin');
        $u->setProductPool($a);
        ...
        $instance = new \Sonata\ProductBundle\Admin\ProductAdmin('sonata.product.admin.product', 'AppBundle\\Entity\\Commerce\\Product', 'SonataProductBundle:ProductAdmin');
        $instance->addChild($r);
        $instance->addChild($s);
        $instance->addChild($t);
        $instance->addChild($u);
    ...
    {
        $instance = new \Sonata\ProductBundle\Admin\ProductCategoryAdmin('sonata.product.admin.product.category', 'AppBundle\\Entity\\Commerce\\ProductCategory', 'SonataAdminBundle:CRUD');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
    ...
    {
        $instance = new \Sonata\ProductBundle\Admin\ProductCollectionAdmin('sonata.product.admin.product.collection', 'AppBundle\\Entity\\Commerce\\ProductCollection', 'SonataAdminBundle:CRUD');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
    ...
    {
        $instance = new \Sonata\ProductBundle\Admin\ProductVariationAdmin('sonata.product.admin.product.variation', 'AppBundle\\Entity\\Commerce\\Product', 'SonataProductBundle:ProductVariationAdmin');
        $instance->setProductPool($this->get('sonata.product.pool'));
        $instance->setCurrencyDetector($this->get('sonata.price.currency.detector'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
    ...
    {
        return $this->services['sonata.product.api.form.type.product.parent'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_product_api_form_product_parent', 'AppBundle\\Entity\\Commerce\\Product', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.product.block.recent_products'] = new \Sonata\ProductBundle\Block\RecentProductsBlockService('sonata.product.block.recent_products', $this->get('templating'), $this->get('doctrine'), $this->get('sonata.price.currency.detector'), 'AppBundle\\Entity\\Commerce\\Product');
    }
    protected function getSonata_Product_Block_SimilarProductsService()
    {
        return $this->services['sonata.product.block.similar_products'] = new \Sonata\ProductBundle\Block\SimilarProductsBlockService('sonata.product.block.similar_products', $this->get('templating'), $this->get('doctrine'), $this->get('sonata.price.currency.detector'), $this->get('sonata.product.finder'), 'AppBundle\\Entity\\Commerce\\Product');
    }
    ...
    {
        return $this->services['sonata.product.form.delivery_type'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\Commerce\\Delivery', 'getStatusList', 'sonata_product_delivery_status');
    }
    ...
    {
        return $this->services['sonata.product.seo_iterator'] = new \Sonata\Component\Product\SeoProductIterator($this->get('doctrine'), 'AppBundle\\Entity\\Commerce\\Product', $this->get('cmf_routing.router'), 'sonata_product_view');
    }
    ...
    {
        return $this->services['sonata.product.set.manager'] = new \Sonata\ProductBundle\Entity\ProductSetManager('AppBundle\\Entity\\Commerce\\Product', $this->get('doctrine'));
    }
    protected function getSonata_Product_Subscriber_OrmService()
    {
        return $this->services['sonata.product.subscriber.orm'] = new \Sonata\Component\Subscriber\ORMInheritanceSubscriber(array('sonata.ecommerce_demo.product.goodie' => 'Sonata\\Bundle\\DemoBundle\\Entity\\Goodie', 'sonata.ecommerce_demo.product.travel' => 'Sonata\\Bundle\\DemoBundle\\Entity\\Travel'), 'AppBundle\\Entity\\Commerce\\Product');
    }
    protected function getSonata_ProductCategory_ProductService()
    {
        return $this->services['sonata.product_category.product'] = new \Sonata\ProductBundle\Entity\ProductCategoryManager('AppBundle\\Entity\\Commerce\\ProductCategory', $this->get('doctrine'));
    }
    protected function getSonata_ProductCollection_ProductService()
    {
        return $this->services['sonata.product_collection.product'] = new \Sonata\ProductBundle\Entity\ProductCollectionManager('AppBundle\\Entity\\Commerce\\ProductCollection', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.timeline.spread.admin'] = new \Sonata\TimelineBundle\Spread\AdminSpread($this->get('doctrine'), 'AppBundle\\Entity\\User\\User');
    }
    ...
    {
        return $this->services['sonata.transaction.manager'] = new \Sonata\PaymentBundle\Entity\TransactionManager('AppBundle\\Entity\\Commerce\\Transaction', $this->get('doctrine'));
    }
    protected function getSonata_User_Admin_GroupService()
    {
        $instance = new \Sonata\UserBundle\Admin\Entity\GroupAdmin('sonata.user.admin.group', 'AppBundle\\Entity\\User\\Group', 'SonataAdminBundle:CRUD');
    ...
    {
        $instance = new \Sonata\UserBundle\Admin\Entity\UserAdmin('sonata.user.admin.user', 'AppBundle\\Entity\\User\\User', 'SonataAdminBundle:CRUD');
        $instance->setUserManager($this->get('fos_user.user_manager'));
        $instance->setTranslationDomain('SonataUserBundle');
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.underscore'));
        $instance->setManagerType('orm');
    ...
    {
        return $this->services['sonata.user.api.form.type.group'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_user_api_form_group', 'AppBundle\\Entity\\User\\Group', 'sonata_api_write');
    }
    protected function getSonata_User_Api_Form_Type_UserService()
    {
        return $this->services['sonata.user.api.form.type.user'] = new \Sonata\CoreBundle\Form\Type\DoctrineORMSerializationType($this->get('jms_serializer.metadata_factory'), $this->get('doctrine'), 'sonata_user_api_form_user', 'AppBundle\\Entity\\User\\User', 'sonata_api_write');
    }
    ...
    {
        return $this->services['sonata.user.form.gender_list'] = new \Sonata\CoreBundle\Form\Type\StatusType('AppBundle\\Entity\\User\\User', 'getGenderList', 'sonata_user_gender');
    }
    ...
    protected function getSpyTimeline_ActionManager_OrmService()
    {
        ...
        $a->addSpread(new \Sonata\TimelineBundle\Spread\AdminSpread($this->get('doctrine'), 'AppBundle\\Entity\\User\\User'));
        ...
        $this->services['spy_timeline.action_manager.orm'] = $instance = new \Spy\TimelineBundle\Driver\ORM\ActionManager($this->get('doctrine.orm.default_entity_manager'), $this->get('spy_timeline.result_builder'), 'AppBundle\\Entity\\Timeline\\Action', 'AppBundle\\Entity\\Timeline\\Component', 'AppBundle\\Entity\\Timeline\\ActionComponent');
    ...
    {
        return $this->services['spy_timeline.query_builder.orm'] = new \Spy\TimelineBundle\Driver\ORM\QueryBuilder\QueryBuilder($this->get('spy_timeline.query_builder.factory'), $this->get('doctrine.orm.default_entity_manager'), $this->get('spy_timeline.result_builder'), 'AppBundle\\Entity\\Timeline\\Action');
    }
    ...
    protected function getSpyTimeline_Spread_Deployer_DefaultService()
    {
        ...
        $instance->addSpread(new \Sonata\TimelineBundle\Spread\AdminSpread($this->get('doctrine'), 'AppBundle\\Entity\\User\\User'));
        return $instance;
    }
    ...
    {
        return $this->services['spy_timeline.timeline_manager.orm'] = new \Spy\TimelineBundle\Driver\ORM\TimelineManager($this->get('doctrine.orm.default_entity_manager'), $this->get('spy_timeline.result_builder'), 'AppBundle\\Entity\\Timeline\\Timeline');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\src\\AppBundle/Resources/translations\\SonataProductBundle.en.xliff'), 'en', 'SonataProductBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\src\\AppBundle/Resources/translations\\SonataProductBundle.fr.xliff'), 'fr', 'SonataProductBundle');
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle/Resources/translations\\SonataNewsBundle.ja.xliff'), 'ja', 'SonataNewsBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle/Resources/translations\\SonataNewsBundle.nl.xliff'), 'nl', 'SonataNewsBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle/Resources/translations\\SonataNewsBundle.pt_BR.xliff'), 'pt_BR', 'SonataNewsBundle');
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\comment-bundle/Resources/translations\\SonataCommentBundle.de.xliff'), 'de', 'SonataCommentBundle');
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\comment-bundle/Resources/translations\\SonataCommentBundle.es.xliff'), 'es', 'SonataCommentBundle');
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\formatter-bundle/Resources/translations\\SonataFormatterBundle.es.xliff'), 'es', 'SonataFormatterBundle');
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\formatter-bundle/Resources/translations\\SonataFormatterBundle.ja.xliff'), 'ja', 'SonataFormatterBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\formatter-bundle/Resources/translations\\SonataFormatterBundle.nl.xliff'), 'nl', 'SonataFormatterBundle');
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\sonata-project\\timeline-bundle/Resources/translations\\SonataTimelineBundle.pt_BR.xliff'), 'pt_BR', 'SonataTimelineBundle');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Sonata\ProductBundle\Twig\Extension\ProductExtension($this->get('sonata.product.pool'), $this->get('form.factory'), 'AppBundle\\Entity\\Commerce\\BasketElement'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\Resources\\config\\validation.xml'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\news-bundle\\Resources\\config\\validation.xml'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\media-bundle\\Resources\\config\\validation.xml'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\BasketBundle\\Resources\\config\\validation.xml'), 6 => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\CustomerBundle\\Resources\\config\\validation.xml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\InvoiceBundle\\Resources\\config\\validation.xml'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\OrderBundle\\Resources\\config\\validation.xml'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\PaymentBundle\\Resources\\config\\validation.xml'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\ecommerce\\src\\ProductBundle\\Resources\\config\\validation.xml'), 11 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle\\Resources\\config\\validation.xml'), 12 => ($this->targetDirs[3].'\\vendor\\sonata-project\\classification-bundle\\Resources\\config\\validation.xml'), 13 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\Resources\\config\\validation.xml'), 14 => ($this->targetDirs[3].'\\vendor\\symfony-cmf\\routing-bundle\\Resources\\config\\validation.xml'), 15 => ($this->targetDirs[3].'\\src\\Sonata\\Bundle\\DemoBundle\\Resources\\config\\validation.xml')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'session.save_path' => ($this->targetDirs[2].'/cache/sessions'),
            ...
            'sonata.page.site.class' => 'AppBundle\\Entity\\Page\\Site',
            'sonata.page.block.class' => 'AppBundle\\Entity\\Page\\Block',
            'sonata.page.snapshot.class' => 'AppBundle\\Entity\\Page\\Snapshot',
            'sonata.page.page.class' => 'AppBundle\\Entity\\Page\\Page',
            'sonata.page.admin.site.entity' => 'AppBundle\\Entity\\Page\\Site',
            'sonata.page.admin.block.entity' => 'AppBundle\\Entity\\Page\\Block',
            'sonata.page.admin.snapshot.entity' => 'AppBundle\\Entity\\Page\\Snapshot',
            'sonata.page.admin.page.entity' => 'AppBundle\\Entity\\Page\\Page',
            ...
            'sonata.news.admin.post.entity' => 'AppBundle\\Entity\\News\\Post',
            'sonata.news.admin.comment.entity' => 'AppBundle\\Entity\\News\\Comment',
            'sonata.news.manager.post.entity' => 'AppBundle\\Entity\\News\\Post',
            'sonata.news.manager.comment.entity' => 'AppBundle\\Entity\\News\\Comment',
            ...
            'sonata.admin.configuration.dashboard_groups' => array(
                'sonata.admin.group.content' => array(
                    ...
                    'items' => array(
                        0 => array(
                            'admin' => 'sonata.news.admin.comment',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        3 => array(
                            'admin' => 'sonata.media.admin.gallery',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        4 => array(
                            'admin' => 'sonata.comment.admin.thread',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                ...
                'sonata.admin.group.ecommerce' => array(
                    ...
                    'items' => array(
                        0 => array(
                            'admin' => 'sonata.customer.admin.customer',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        1 => array(
                            'admin' => 'sonata.invoice.admin.invoice',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        2 => array(
                            'admin' => 'sonata.order.admin.order',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        3 => array(
                            'admin' => 'sonata.product.admin.product',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                ...
                'sonata.admin.group.classification' => array(
                    ...
                    'items' => array(
                        ...
                        1 => array(
                            'admin' => 'sonata.classification.admin.tag',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        2 => array(
                            'admin' => 'sonata.classification.admin.collection',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        3 => array(
                            'admin' => 'sonata.classification.admin.context',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                ...
                'sonata.admin.group.administration' => array(
                    ...
                    'items' => array(
                        ...
                        3 => array(
                            'admin' => 'sonata.notification.admin.message',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                ...
                'sonata.admin.group.demo' => array(
                    ...
                    'items' => array(
                        ...
                        1 => array(
                            'admin' => 'sonata.demo.admin.engine',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
                        ...
                        3 => array(
                            'admin' => 'sonata.demo.admin.material',
                            'label' => '',
                            'route' => '',
                            'route_params' => array(
                            ),
            ...
            'simplethings.entityaudit.audited_entities' => array(
                ...
                1 => 'AppBundle\\Entity\\User\\Group',
                2 => 'AppBundle\\Entity\\Page\\Page',
                3 => 'AppBundle\\Entity\\Page\\Block',
                5 => 'AppBundle\\Entity\\Page\\Snapshot',
                6 => 'AppBundle\\Entity\\Page\\Site',
                7 => 'AppBundle\\Entity\\News\\Post',
                8 => 'AppBundle\\Entity\\News\\Comment',
                9 => 'AppBundle\\Entity\\Media\\Media',
                10 => 'AppBundle\\Entity\\Media\\Gallery',
                11 => 'AppBundle\\Entity\\Media\\GalleryHasMedia',
                12 => 'AppBundle\\Entity\\Commerce\\Customer',
                13 => 'AppBundle\\Entity\\Commerce\\Address',
                14 => 'AppBundle\\Entity\\Commerce\\Invoice',
                15 => 'AppBundle\\Entity\\Commerce\\Order',
                16 => 'AppBundle\\Entity\\Commerce\\OrderElement',
                17 => 'AppBundle\\Entity\\Commerce\\Product',
                19 => 'AppBundle\\Entity\\Commerce\\ProductCategory',
                20 => 'AppBundle\\Entity\\Commerce\\ProductCollection',
                21 => 'AppBundle\\Entity\\Commerce\\Delivery',
                22 => 'AppBundle\\Entity\\Comment\\Comment',
                23 => 'AppBundle\\Entity\\Comment\\Thread',
                24 => 'AppBundle\\Entity\\Classification\\Category',
                25 => 'AppBundle\\Entity\\Classification\\Tag',
                26 => 'AppBundle\\Entity\\Classification\\Collection',
                27 => 'AppBundle\\Entity\\Classification\\Context',
                28 => 'AppBundle\\Entity\\Notification\\Message',
                29 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Car',
                30 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Engine',
                31 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Color',
                32 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Material',
                33 => 'Sonata\\Bundle\\DemoBundle\\Entity\\Inspection',
            ),
            ...
            'sonata.basket.basket.class' => 'AppBundle\\Entity\\Commerce\\Basket',
            'sonata.basket.basket_element.class' => 'AppBundle\\Entity\\Commerce\\BasketElement',
            ...
            'sonata.customer.customer.class' => 'AppBundle\\Entity\\Commerce\\Customer',
            'sonata.customer.address.class' => 'AppBundle\\Entity\\Commerce\\Address',
            'sonata.customer.admin.customer.entity' => 'AppBundle\\Entity\\Commerce\\Customer',
            'sonata.customer.admin.address.entity' => 'AppBundle\\Entity\\Commerce\\Address',
            ...
            'sonata.invoice.invoice.class' => 'AppBundle\\Entity\\Commerce\\Invoice',
            'sonata.invoice.invoice_element.class' => 'AppBundle\\Entity\\Commerce\\InvoiceElement',
            'sonata.invoice.admin.invoice.entity' => 'AppBundle\\Entity\\Commerce\\Invoice',
            'sonata.invoice.admin.invoice_element.entity' => 'AppBundle\\Entity\\Commerce\\InvoiceElement',
            ...
            'sonata.order.order.class' => 'AppBundle\\Entity\\Commerce\\Order',
            'sonata.order.order_element.class' => 'AppBundle\\Entity\\Commerce\\OrderElement',
            'sonata.order.admin.order.entity' => 'AppBundle\\Entity\\Commerce\\Order',
            'sonata.order.admin.order_element.entity' => 'AppBundle\\Entity\\Commerce\\OrderElement',
            ...
            'sonata.payment.transaction.class' => 'AppBundle\\Entity\\Commerce\\Transaction',
            ...
            'sonata.product.product.class' => 'AppBundle\\Entity\\Commerce\\Product',
            'sonata.product.package.class' => 'AppBundle\\Entity\\Commerce\\Package',
            'sonata.product.product_category.class' => 'AppBundle\\Entity\\Commerce\\ProductCategory',
            'sonata.product.product_collection.class' => 'AppBundle\\Entity\\Commerce\\ProductCollection',
            'sonata.product.category.class' => 'AppBundle\\Entity\\Classification\\Category',
            'sonata.product.collection.class' => 'AppBundle\\Entity\\Classification\\Collection',
            'sonata.product.delivery.class' => 'AppBundle\\Entity\\Commerce\\Delivery',
            'sonata.product.admin.product.entity' => 'AppBundle\\Entity\\Commerce\\Product',
            'sonata.product.admin.package.entity' => 'AppBundle\\Entity\\Commerce\\Package',
            'sonata.product.admin.product_category.entity' => 'AppBundle\\Entity\\Commerce\\ProductCategory',
            'sonata.product.admin.product_collection.entity' => 'AppBundle\\Entity\\Commerce\\ProductCollection',
            'sonata.product.admin.category.entity' => 'AppBundle\\Entity\\Classification\\Category',
            'sonata.product.admin.collection.entity' => 'AppBundle\\Entity\\Classification\\Collection',
            'sonata.product.admin.delivery.entity' => 'AppBundle\\Entity\\Commerce\\Delivery',
            ...
            'fos_comment.model.thread.class' => 'AppBundle\\Entity\\Comment\\Thread',
            'fos_comment.model.comment.class' => 'AppBundle\\Entity\\Comment\\Comment',
            ...
            'sonata.comment.class.comment.entity' => 'AppBundle\\Entity\\Comment\\Comment',
            'sonata.comment.class.thread.entity' => 'AppBundle\\Entity\\Comment\\Thread',
            ...
            'sonata.notification.backend' => 'sonata.notification.backend.postpone',
            'sonata.notification.message.class' => 'AppBundle\\Entity\\Notification\\Message',
            'sonata.notification.admin.message.entity' => 'AppBundle\\Entity\\Notification\\Message',
            'sonata.notification.manager.message.entity' => 'AppBundle\\Entity\\Notification\\Message',
            ...
            'spy_timeline.class.timeline' => 'AppBundle\\Entity\\Timeline\\Timeline',
            'spy_timeline.class.action' => 'AppBundle\\Entity\\Timeline\\Action',
            'spy_timeline.class.component' => 'AppBundle\\Entity\\Timeline\\Component',
            'spy_timeline.class.action_component' => 'AppBundle\\Entity\\Timeline\\ActionComponent',
            ...
            'sonata.timeline.admin.timeline.entity' => 'AppBundle\\Entity\\Timeline\\Timeline',
            'sonata.timeline.admin.action.entity' => 'AppBundle\\Entity\\Timeline\\Action',
            'sonata.timeline.admin.action_component.entity' => 'AppBundle\\Entity\\Timeline\\ActionComponent',
            'sonata.timeline.admin.component.entity' => 'AppBundle\\Entity\\Timeline\\Component',
