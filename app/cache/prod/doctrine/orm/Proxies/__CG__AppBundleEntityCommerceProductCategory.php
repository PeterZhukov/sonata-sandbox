 ...
 */
class ProductCategory extends \AppBundle\Entity\Commerce\ProductCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'enabled', 'main', 'updatedAt', 'createdAt', 'product', 'category');
        }
