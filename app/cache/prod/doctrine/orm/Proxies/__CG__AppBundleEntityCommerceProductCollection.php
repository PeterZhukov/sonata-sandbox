...
namespace Proxies\__CG__\AppBundle\Entity\Commerce;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ProductCollection extends \AppBundle\Entity\Commerce\ProductCollection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'enabled', 'updatedAt', 'createdAt', 'product', 'collection');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductCollection $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCollection(\Sonata\ClassificationBundle\Model\CollectionInterface $collection)
    {
