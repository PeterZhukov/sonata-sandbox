 ...
 */
class Package extends \AppBundle\Entity\Commerce\Package implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'product', 'width', 'height', 'length', 'weight', 'enabled', 'updatedAt', 'createdAt');
        }
